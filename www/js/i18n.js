...
const I18N = {
  ja: {
    ...
    phoneNumberLabel: "電話番号（任意）",
    phoneNumberPlaceholder: "例: 090-xxxx-xxxx",
    callNowBtn: "電話をかける",
    preNotifyLabel: "1秒前に予告する",
    preNotifyDesc: "予約電話・チケット発売・投稿・配信などで、1秒前に短い音とアナウンスでお知らせします。",
    ...
    runningBtn: "秒合わせ中",
    cancelBtn: "キャンセル",
    canceledText: "キャンセルしました",
    alreadyRunningText: "すでに秒合わせ中です。キャンセルしてから再設定してください。",
    retryBtn: "もう一度",
    homeBtn: "ホームに戻る",
    wakeUpText: "起きて！",
    quietAlertText: "静かに通知",
    sleepModeText: "スリープモード",
    endBtn: "終了",
  ...
  en: {
    ...
    presetLabel: "Presets",
    preset_sleep_a: "Sleep ",
    preset_sleep_b: " sec",
    preset_call: "📞 Call",
    preset_post: "💬 Post / Go Live",
    ...
    phoneNumberPlaceholder: "e.g. 090-xxxx-xxxx",
    callNowBtn: "Call Now",
    preNotifyLabel: "1-Second Warning",
    preNotifyDesc: "For calls, ticket sales, posting and going live — get a short sound and announcement 1 second before.",
    ...
    runningBtn: "Second Sync Running",
    cancelBtn: "Cancel",
    canceledText: "Canceled",
    alreadyRunningText: "Second Sync is already running. Please cancel it before setting a new one.",
    retryBtn: "Try Again",
    homeBtn: "Back to Home",
    wakeUpText: "Wake up!",
    quietAlertText: "Quiet Alert",
    sleepModeText: "Sleep Mode",
    endBtn: "End",
